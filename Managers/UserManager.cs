...
namespace CookMaster.Managers
{
    ...
    public class UserManager : INotifyPropertyChanged // Implementerar interface för att möjliggöra "data binding"
    {
        ...
        private void CreateDefaultUsers()
        {
            ...
            _userlist.Add(new User { UserName ="LindaMaria", Password = "0000", DisplayName="Administratör", EmailAddress="lima@live.se", Role="admin" } );
            // Lägger till ytterligare två användare
            _userlist.Add(new User { UserName = "Elsa", Password = "0001", DisplayName = "Elsa", EmailAddress = "elsa@live.se", Role = "member" });
            _userlist.Add(new User { UserName = "Elvis", Password = "0002", DisplayName = "Elvis", EmailAddress = "elvis@live.se", Role = "member" });
        }
